...
export default function DetailPage() {
    return (
        <div className="min-h-screen bg-white flex flex-col gap-10">
            <article className="flex flex-col px-3 pt-10 pb-3 space-y-8">
                ...
                <section className=" flex flex-col md:grid sm:grid-cols-2 gap-5 pb-10">
                    <section>
                        <h2 className="text-xl sm:text-3xl underline">Expense Description:</h2>
                        <p className="text-sm sm:text-lg">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nulla, commodi exercitationem! Debitis, porro ad earum, 
                            aut dolores dolore velit labore praesentium eligendi optio quod, rerum deserunt sint voluptatibus saepe iusto.
                        </p>
                    </section>
                    <section>
                        <h2 className="text-xl sm:text-3xl underline">Additional Notes:</h2>
                        <p className="text-sm sm:text-lg">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nulla, commodi exercitationem! Debitis, porro ad earum, 
                            aut dolores dolore velit labore praesentium eligendi optio quod, rerum deserunt sint voluptatibus saepe iusto.
                        </p>
                    </section>
