...
export default function Table({ expenses }: TableProp) {
    return (
        <section className="overflow-x-scroll print:overflow-visible">
            <table className="w-full">
                <thead>
                    <tr>
                        ...
                        <th className="border-3 border-black bg-indigo-600 text-white font-bold text-start p-2">Description</th>
                        <th className="border-3 border-black bg-indigo-600 text-white font-bold text-start p-2">Vendor</th>
                        ...
                        expenses?.map(expenseItem => {
                            return (
                                <tr key={expenseItem.id}>
                                    ...
                                    <td className="border-3 border-black text-start p-1">{expenseItem.description}</td>
                                    <td className="border-3 border-black text-start p-1">{expenseItem.vendor}</td>
