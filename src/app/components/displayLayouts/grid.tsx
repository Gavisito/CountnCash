...
export default function Grid() {
    return (
        <div className="grid grid-cols-2 gap-2 mt-6">
            <article className="border-black border-3 h-auto p-3 sm:p-5 flex flex-col w-full rounded-lg">
                <h2 className="text-base font-bold underline sm:text-xl md:text-2xl mb-3">Taco Bamaba Food</h2>
